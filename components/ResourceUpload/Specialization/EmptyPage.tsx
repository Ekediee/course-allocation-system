...
const EmptyPage: React.FC<EmptyPageProps> = ({title, desc, btnName, onAddSpecialization}) => {
  return (
    <>
        <div className="flex flex-col items-center justify-center text-center mt-4 py-16 px-4 bg-blue-100 h-[510px] rounded-3xl">
            ...
            <SpecializationModal btnName={btnName} onAddSpecialization={onAddSpecialization} />
        </div>
    </>
  )
}
